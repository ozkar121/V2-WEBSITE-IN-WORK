...
- **Alcance suficiente** para conectar la mayoría de las ciudades sin escalas de combustible
- **Cabina espaciosa** con altura para estar de pie (6+ pies) y espacio para trabajar
- **Velocidad de crucero** de 430-500 nudos que reduce significativamente los tiempos de vuelo
- **Costos operativos** más razonables que los jets de cabina grande

## Las Distancias Clave

Para entender qué aeronave necesitas, estas son las distancias aproximadas desde Toluca (MMTO):

| Ruta | Distancia (NM) | Tipo de Jet Recomendado |
|---|---|---|
...
El Hawker 800 es uno de los caballos de batalla más confiables de la aviación privada y una aeronave emblemática de la flota disponible a través de Numen Aviation.

**Especificaciones:**
- **Alcance:** ~2,540 NM (800A) / ~2,600 NM (800XP)
- **Velocidad de crucero:** 430 nudos
- **Pasajeros:** 6-8
- **Cabina:** Altura de 5'9", longitud de 21.3 ft
- **Equipaje:** Compartimento amplio accesible en vuelo

**Ideal para:** Toluca → Houston, Dallas, Miami, San Antonio. El Hawker 800A es una de las aeronaves más populares de Numen Aviation para rutas a EUA, combinando confiabilidad probada con costos operativos razonables. Su rendimiento en aeropuertos de elevación como Toluca (2,660 m) es excelente.

### Hawker 900XP

La evolución del 800XP con mayor alcance y motores más eficientes.

**Especificaciones:**
- **Alcance:** ~2,800 NM
- **Velocidad de crucero:** 448 nudos
- **Pasajeros:** 8-9
- **Cabina:** Mismas dimensiones que el 800XP con mejoras en acabados
...
Un jet ligero-mediano que destaca por su velocidad y eficiencia en rutas cortas a medianas.

**Especificaciones:**
- **Alcance:** ~2,040 NM
- **Velocidad de crucero:** 465 nudos — uno de los más rápidos de su clase
- **Pasajeros:** 6-8
- **Cabina:** Diseño ejecutivo moderno con conectividad
...
**Distancia de despegue.** A mayor elevación, el aire es menos denso y las aeronaves necesitan más pista para despegar. La pista de 4,200 metros de Toluca elimina esta preocupación para prácticamente todas las aeronaves de categoría midsize y super-midsize.

**Payload vs. alcance.** En días calurosos a gran elevación, algunas aeronaves pueden necesitar reducir carga (pasajeros o combustible) para cumplir con las limitaciones de despegue. Los Hawker, Challenger y Gulfstream están diseñados para manejar estas condiciones con mínimas restricciones.

**Combustible.** El consumo de combustible es ligeramente mayor en el despegue desde aeropuertos elevados, lo que puede reducir marginalmente el alcance efectivo. Esto se debe considerar al planificar rutas al límite del alcance de la aeronave.
